          ...
          <div className="container my-2 mx-auto md:px-6">
              <section className="mb-32">
                  ...
                  <div className="container px-6 md:px-12">
                      <div
                          className="block rounded-lg bg-[#000000] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
                                  ...
                                  <form>
                                      ...
                                      <div className="relative mb-6" data-te-input-wrapper-init>
                                          ...
                                          <label for="exampleFormControlTextarea1"
                                              className="pointer-events-none text-white absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary">Message</label>
                                      </div>
                                      <div className="mb-6 inline-block min-h-[1.5rem] justify-center pl-[1.5rem] md:flex">
                                          ...
                                          <label className="inline-block text-white pl-[0.15rem] hover:cursor-pointer" for="exampleCheck96">
